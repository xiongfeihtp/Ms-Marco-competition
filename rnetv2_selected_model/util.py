    ...
    def parse(example):
        ...
        features = tf.parse_single_example(example,
                                           features={
                                               ...
                                               "is_selected": tf.FixedLenFeature([], tf.int64)
                                           })
        ...
        is_selected = features["is_selected"]
        qa_id = features["id"]
        return passage_idxs, ques_idxs, passage_char_idxs, ques_char_idxs, y1, y2, is_selected, qa_id
